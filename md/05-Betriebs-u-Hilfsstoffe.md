...
**Fraktionierende Destillation** darunter versteht man das Aufteilen von Rohöl nach Siedebereichen. Hierzu wird das Rohöl erhitzt und in eine Kolonne geleitet, wo die einzelnen Bestandteile kondensieren und über Glockenböden abgeführt werden. 
...
**Schwefel** giftig und hat schmierende Wirkung $\to$ Kraftstoff entschwefeln (Ersatzstoff gesucht) und **Harz** betrifft Oldtimer, wo die  Einspritzung verharzen kann.

# Ottokraftstoffe -- leicht siedende Kraftstoffe

*Bemerkung:* 

- **Flammpunkt** beschreibt den Punkt oberhalb einer Flüssigkeit um eine Flamme entstehen lassen zu können durch eine fremde Zündquelle d.h. beginn des Ausgasens eines Kraftstoffes um über ihn ein Zündfähiges Gemisch bilden zu können, was sich durch eine extrene Zündquelle endzünden kann vs. **Selbstentzündungstemperatur** entzündet sich selbst (Dieselkraftstoff)
...
1. **Flammpunkt** unter $<-35~^\circ\text{C}$
...
1. **Siedebereich** Verdampfen zwischen $30^\circ\text{C} \text{ und } 215^\circ\text{C}$
 
1. **Kaltstartverhalten** damit ein kalter bzw. noch nicht betriebswarmer Motor bei niedrigen Temperaturen sicher anspringt und im Leerlauf rund läuft, benötigt er einen Kraftstoff mit niedriger Siedekurve. 
    - **E70-Punkt** verdampfter Anteil bei $70~^\circ\text{C}$
    - **T10-Punkt** Temperatur, bei dem $10~\%$ des Kraftstoffs verdampft sind
 
1. **Heisstartverhalten**  Bei einem betriebswarmen oder heißen Motor sowie im Sommer besteht die Gefahr der Dampfblasenbildung im Kraftstoffsystem. (zu viel Luft) Beispiel: K-Jetronic 
...
7. **Arten von Klopfbremsen** (Maßnahmen, um die Klopffestigkeit zu erhöhen)
    ...
    - metallfreien Klopfbremsen wie Benzol, begrenzt auf 1 Vol.-\% sind stark krebserregend, sind sehr effektiv
...
**Trockensiedepunkt / Mindestsiedepunkte:** DOT3 = $205~^\circ\text{C}$, DOT4 = $230~^\circ\text{C}$, DOT5.1 = $260~^\circ\text{C}$
...
**Nass-Siedepunkt** ist der Siedepunkt bei $3,5~^\circ\text{C}$ Wasseranteil. (nach ca. 2 Jahren erreicht) Vgl. Tabelle
...
"Je höher der Anteil an Wasser, desto niedriger wird der Siedepunkt." Gefahr der Dampfblasenbildung durch die beim Bremsen entstehenden Wärme.
...
1. **Super E5** Gemisch aus $95~\%$ Benzin und bis zu $5~\%$ Bioethanol
1. **E10** Gemisch aus $90~\%$ Benzin und bis zu $10~\%$ Bioethanol
...
- *Nachteil:* geringer Heizwert (hoher Verbrauch, geringe Reichweite)
- *Nachteil:* Ethanol wirkt als Lösungsmittel und kann Dichtungen angreifen
...
1. **Flammpunkt** über $>55~^\circ\text{C}$
1. **Siedebereich** Verdampfen zwischen $170^\circ\text{C} \text{ und } 380^\circ\text{C}$ 
1. **Selbstentzündungstemperatur** ca. $220~^\circ\text{C}$
...
- beim Verbrennen: von Schwefel und Wasser $\to$ **Folge** Säure / Übersäuren (vgl. Eigenschaften von Biodiesel)
...
**Merkmale von Vollsynthetischen Öl**
...
*Bemerkung:* beim Wechsel von Mineralöl zu Synthetiköl ist das erste Wechselintervall aufgrund der starken reinigenden Wirkung verkürzt werden muss.

**Einteilung der Motoröle**
...
**Freigabe-Vorschriften der Hersteller beachten**, um Motorschäden oder Schäden an der Einspritzanlage zu vermeiden.

**Mehrbereichsöle** sind Schmieröle, die mehr als eine Viskositätsklasse abdecken. 
*Beispiel:* **SAE 15W-40** verhält sich bei tiefen Temperaturen wie ein Öl der Klasse 15W und bei hohen Temperaturen wie ein SAE 40 Öl. 

"Je kleiner die Zahl vor dem *W*, desto fließfähiger ist das Öl in der Kälte und je höher die SAE-Kennzahl, desto zähflüssiger ist das Öl."
...
Öl hat eine *niedrige Viskosität* und damit einen niedrigen Verformungswiderstand, wenn es dünnflüssig (fließfähiger, Leichtlaufeffekt) ist und eine *hohe Viskosität*, wenn es Zähflüssig ist. 

Die Tragfähigkeit des Schmerzfilms ist allerdings bei höheren Viskosität besser als bei einer niedrigen.

**Ermittlung der Viskosität eines Öls** 

1. Kinematische Viskosität (Kapillarviskosimeter)
1. Dynamische Viskosität (Rotationsviskosimeter)

**Nenne 5 -- 7x Additive und Eigenschaften**

1. **Detergants** Schmutz lösen (von Metalloberflächen Beispiel: Kolben und Ölleitungen, halten dadurch geschmierte Oberflächen sauber)

1. **Dispersants** Schmutz in der Schwebe halten (verhindern Ablagerungen, Schlammbildung)
...
**Stockpunkt** gibt die Temperatur an, bei der das Öl "stockt". Dadurch ist gewährleistet, dass beim Motorstart genügend Öl zur Ölpumpe und in den Schmierölkreislauf fließt. 
...
**Konsistenz** ist der Widerstand eines Fettes gegen Verformung. Die Eindringtiefe eines genormten Kegels in das Fett führt zur Einteilung in die NLGI-Klassen.
